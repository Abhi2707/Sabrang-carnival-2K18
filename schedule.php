<html>
    ...
    <head>
        ...
        <title>Schedule|Sabrang|JKLU</title>
...
color:white;
    ...
    <body>
        ...
        <h1><center>Schedule Not Available Yet!</center></h1>

        <div style="position:relative;top:20%;">

            <h4><center>We will notify you when it's available</center></h4>
...
<script>
   ...
   if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","http://sabrang.jklu.edu.in/schedule.php?STORE_NAME="+name+"&STORE_EMAIL="+email+"&FLAG="+flag,true);
        xmlhttp.send();}
